 ...
 * 
 * Revised July 13, 2016: Added getSchedules method
 */
package persistence;
...
public class LeagueDAO {
	...
	/**
	 * Retrieves all schedules from the NHL league
	 * @return ArrayList<Schedule> containing all schedules in the NHL
	 */
	public ArrayList<Schedule> getSchedules()
	{
		...
		em = emf.createEntityManager();
		em.getTransaction().begin();
		schedules = (ArrayList<Schedule>)em
				.createQuery("SELECT s FROM Schedule s WHERE s.league = 'NHL'", Schedule.class)
				.getResultList();
		em.close();
