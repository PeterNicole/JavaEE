 ...
 * 
 * Revised August 13, 2016: Added the nextGame transient property
 */
package persistence;
...
public class Team implements Comparable<Team>{
	...
	@Transient
	/**
	 * Unmapped property which is used to store the string representing the next game date
	 * @return Date of next game
	 */
	...
	/**
	 * Setter for the unmapped nextGame property
	 * @param nextGame
	 */
