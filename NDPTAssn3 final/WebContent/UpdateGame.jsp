...
<jsp:include page="Banner.jsp" />
	...
	<br/>	
	<form name="frmUpdateGame" method="post" action="UpdateGame">
		...
		<label for="SO" class="radio-inline"><b>SO:</b></label><input type="radio" name="SO_OT" id="SO" value="SO-Y" class="radio-inline"/>
		<label for="OT" class="radio-inline"><b>OT:</b></label><input type="radio" name="SO_OT" id="OT" value="OT-Y" class="radio-inline"/>
		</div>
